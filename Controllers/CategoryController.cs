...
namespace ChaitraliAPI.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> AllCategories()
        {
            try
            {
                var githubUrl = "https://raw.githubusercontent.com/Chaitrali-tambe/ChaitraliJson/refs/heads/main/category.json";
                ...
                var data = JsonSerializer.Deserialize<CategoriesModel>(jsonString, new JsonSerializerOptions
                {
